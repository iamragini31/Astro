...
function GetReportsWithDetails() {
    debugger
    $.ajax({
        url: "/GetReport/GetReportsWithDetails/",
        type: "GET",
        ...
        success: function (Res) {
            ...
            for (var i = 0; i < datares.length; i++) {
                ...
                tabstring += "<h5>" + datares[i].Reportname + "</h5>"
                ...
                tabstring += " <li style='display:inline'><a  href='/SpecialistServices/SpecialistServices?ID=" + datares[i].ReportID + "&PartnerFlag=" + datares[i].PartnerFlag + " &Type=Report'>Get Report </a> </li>"
                tabstring += "  </ul>"
                tabstring += "</div>"
                tabstring += "</div>"
                tabstring += "</div>"
            ...
            $("#GetReportsWithDetailsAndImages").append(tabstring);
        }
