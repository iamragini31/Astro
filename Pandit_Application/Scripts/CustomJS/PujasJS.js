...
function GetPujasWithDetails() {
    debugger
    $.ajax({
        url: "/Pujas/GetPujasWithDetails/",
        type: "GET",
        ...
        success: function (Res) {
            ...
            for (var i = 0; i < datares.length; i++) {
                ...
                //tabstring += "<h5>" + datares[i].Pujasname +"</h5>"
                //tabstring += "<p class='find' style='padding-bottom:10px'>"
                ...
                //tabstring += "<p><a href='/SelectedPuja/SelectedPuja?ID=" + datares[i].PujaID + "&Servicename=Pooja'>Book Now</a></p>"
                //tabstring += "</div>"
                //tabstring += "</div>"
                //tabstring += "</div>"
                //tabstring += "</div>"
                ...
                var Puja = "CheckLogin(" + datares[i].PujaID + ",1)";
                ...
                tabstring += " <li style='display:inline'><a  href='/SpecialistServices/SpecialistServices?ID=" + datares[i].PujaID + "&Type=Puja'>Book Now</a> </li>"
                tabstring += "  </ul>"
                tabstring += "</div>"
                tabstring += "</div>"
                tabstring += "</div>"
                ...
                //tabstring += "</div>"
                //tabstring += "<div class='hs_lest_news_cont_bottom_right'>"
                //tabstring += "<p><a  href='/SpecialistServices/SpecialistServices?ID=" + datares[i].PujaID + "&Type=Puja'>Book Now</a></p>"
                //tabstring += "</div>"
                //tabstring += "</div>"
                //tabstring += "</div>"
                //tabstring += "</div>"
            ...
            $("#GetPujasWithDetailsAndImages").append(tabstring);
        }
