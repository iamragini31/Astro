   ...
   public class ServicesMaster
    {
        ...
        public int UpdateService(ServicesMasterModel servicesmastermodel)
        {
            ...
            res = clsDataAccess.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_Insert_Service_Details", p1, p2, p3, p4, p6,p5, p8, flag);
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Servicesmastermodel.ChangeStatus = dt.Rows[i]["Status"].ToString();
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        pujamastermodel.ChangeStatus = dt.Rows[i]["flag"].ToString();
